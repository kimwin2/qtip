#!/bin/bash
# ============================================================================
# Zero-shot Benchmark Evaluation: Qwen3-4B (2-bit QTIP)
# Benchmarks: HellaSwag, PIQA, WinoGrande, ARC-Easy, ARC-Challenge
# Framework:  lm_eval 0.4.8
#
# 사용법: bash eval_zeroshot_4b.sh
#         bash eval_zeroshot_4b.sh --limit 100  # 디버깅용
# ============================================================================
set -e
...
echo "============================================================"
echo " Zero-shot Evaluation: Qwen3-4B (2-bit QTIP)"
echo "============================================================"
echo " Model:   ${HF_PATH}"
echo " Tasks:   ${TASKS}"
