#!/bin/bash
# ============================================================================
# Zero-shot Benchmark Evaluation: Qwen3-1.7B (2-bit QTIP)
# Benchmarks: HellaSwag, PIQA, WinoGrande, ARC-Easy, ARC-Challenge
# Framework:  lm_eval 0.4.8
#
# 사용법: bash eval_zeroshot_1.7b.sh
#         bash eval_zeroshot_1.7b.sh --limit 100  # 디버깅용
# ============================================================================
set -e
...
# ===== Configuration =====
MODEL_NAME="qwen3_1.7b_2bit"
BASE_MODEL="/models/Qwen/Qwen3-1.7B-Base"
HF_PATH="hf/qwen3_1.7b_2bit_e2e"
...
echo "============================================================"
echo " Zero-shot Evaluation: Qwen3-1.7B (2-bit QTIP)"
echo "============================================================"
echo " Model:   ${HF_PATH}"
echo " Tasks:   ${TASKS}"
