#!/bin/bash
# ============================================================================
# Qwen3-1.7B QTIP Quantization Pipeline
# 전체 파이프라인: Hessian → Quantize → HFize → E2E Finetune → Eval PPL
#
# 사용법: bash run_qwen3_1.7b.sh
# ============================================================================
set -e  # 에러 시 즉시 종료
...
# ===== Configuration =====
BASE_MODEL="/models/Qwen/Qwen3-1.7B-Base"
HESS_DIR="hessians/qwen3_1.7b"
CKPT_DIR="ckpt/qwen3_1.7b_2bit"
HF_DIR="hf/qwen3_1.7b_2bit"
HF_E2E_DIR="hf/qwen3_1.7b_2bit_e2e"
LOG_DIR="logs"
LOG_FILE="${LOG_DIR}/qwen3_1.7b_2bit.log"
...
echo "=============================================="
echo " Qwen3-1.7B QTIP Quantization Pipeline"
echo "=============================================="
